...
export const KNOPEN: Knoop[] = [
  ...
  },
  {
    ...
    stappen: [
      ...
      'Losmaken: maak de overhandse knoop los en laat de slipsteek lopen terwijl je het remtouw weer vasthoudt.',
    ],
    kvb: ['kvb3'],
  ...
  },
  {
    ...
    categorie: 'Inbinden',
    waarvoor:
      'Een vaste lus die na belasting makkelijk los te maken is. Wordt niet in de KVB-opleiding aangeleerd en hier enkel ter info opgenomen. Gebruik voor het inbinden steeds de achtknoop.',
    stappen: [
      'Maak een kleine lus in het touw (het oog).',
      'Steek het uiteinde van onder door het oog.',
      'Leid het uiteinde rond de staande streng en terug door het oog naar beneden.',
      'Trek strak aan. Let op: een paalsteek kan losschudden, dus altijd met een back-up afwerken. Niet gebruiken om in te binden.',
    ],
    optioneel: true,
